        ...
        <div>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-1 small">
                    <li class="breadcrumb-item"><a href="manageItem_admin.php" class="text-decoration-none text-muted">Items</a></li>
                    <li class="breadcrumb-item active">Details</li>
                </ol>
            </nav>
            <h1 class="fw-bold h2 mb-0"><?= htmlspecialchars($item_name_title) ?></h1>
        </div>
        <a href="manageItem_admin.php" class="btn btn-white border shadow-sm px-4 rounded-4 bg-white">Back</a>
    </div>
