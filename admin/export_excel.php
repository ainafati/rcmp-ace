...
// Pengesahan - Mesti admin
if (!isset($_SESSION['admin_id'])) {
    die("Access denied. Please log in as admin.");
}

// Tentukan laporan mana yang hendak dieksport
$export_type = isset($_GET['export']) ? $_GET['export'] : '';

// =======================================================
// PILIHAN 1: EKSPORT LAPORAN PEMULANGAN
// =======================================================
if ($export_type == 'returns') {
    
    // 1. Dapatkan filter dari URL
    ...
    // 2. Bina Query (SAMA MACAM report_admin.php, TAPI TANPA LIMIT/OFFSET)
    ...
    $sql_report = "SELECT 
                 ...
                 ORDER BY a.asset_code ASC"; // Susun ikut asset code (atau ikut apa yang anda mahu)
...
// =======================================================
// PILIHAN 2: EKSPORT LOG AKTIVITI
// =======================================================
    ...
    $sql_log = "SELECT log_id, timestamp, user_type, user_id, action, details, ip_address 
                 ...
                 ORDER BY timestamp ASC"; // Susun ikut tarikh lama ke baru (atau DESC)
