...
$role = "Technician"; // Kita tambah balik variable yang hilang ni
$fullName = $techName;
...
while ($row = mysqli_fetch_assoc($result)) {
    ...
    if ($date == $today) { $group_name = "TODAY"; } 
    elseif ($date == $yesterday) { $group_name = "YESTERDAY"; } 
    else { $group_name = date('d M Y', strtotime($date)); }
    
    $grouped_notifications[$group_name][] = $row;
}

function get_pending_count($conn) {
    $sql = "SELECT COUNT(DISTINCT reserve_id) as total FROM reservation_items WHERE status = 'Pending'";
...
<div class="main-content">
    <div class="topbar">
        ...
        <a href="dashboard_tech.php" class="btn-back">
...
$(document).ready(function() {
    $('.view-btn').on('click', function() {
        ...
        $('#modalContent').load('fetch_reservation.php?id=' + resId);
    });
});
</script>
