...
// Tukar untuk mematikan paparan ralat pada CLI
ini_set('display_errors', 0);

// Gunakan kod integer 0 untuk mematikan pelaporan ralat sepenuhnya
error_reporting(0); 

// Tentukan DIRECTORY SEMASA SKRIP INI BERADA
$base_dir = __DIR__; 
