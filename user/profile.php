...
<head>
    ...
    <style>
        ...
        body { 
            ...
            background-color: #f8fafc; /* Latar belakang kelabu sangat cerah */
            color: #334155;
            min-height: 100vh; 
        }

        /* 2. SIDEBAR (Tema Putih Baru) */
        .sidebar { 
...
<small class="form-text text-muted">Full name cannot be changed.</small>                            </div>
                            <div class="mb-3">
